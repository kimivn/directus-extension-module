...
import { defineComponent, computed, resolveComponent, createElementBlock, openBlock, Fragment, renderList, createElementVNode, normalizeStyle, createVNode, toDisplayString, shallowRef, h, ref, onMounted, onUnmounted, watch, toRaw, nextTick, version as version$1, isProxy, createBlock, unref, pushScopeId, popScopeId, withScopeId, markRaw, shallowReactive, resolveDirective, withDirectives, normalizeClass, createCommentVNode, renderSlot, resolveDynamicComponent, withCtx, mergeProps, toHandlers, createTextVNode, createStaticVNode, isRef } from 'vue';
...
const mockOrders = generateMockOrders(300);
  ...
  getters: {
    filteredOrders(state) {
      ...
      return state.orders.filter((order) => {
        const matchesSearch = !query || order.name.toLowerCase().includes(query) || order.customer_name.toLowerCase().includes(query) || order.customer_email.toLowerCase().includes(query);
        const matchesStatus = !status || status === "all" || order.status === status;
        return matchesSearch && matchesStatus;
      });
    },
    pagedOrders(state) {
      return this.filteredOrders.slice(0, state.limit);
    },
    hasMore(state) {
      return state.limit < this.filteredOrders.length;
    }
  },
  actions: {
...
const _hoisted_1$6 = { class: "stats-grid" };
const _hoisted_2$4 = { class: "stat-content" };
const _hoisted_3$3 = { class: "stat-label" };
...
const _hoisted_1$5 = { class: "data-section chart-section" };
const _hoisted_2$3 = { class: "chart-container" };
const _hoisted_3$2 = {
  key: 1,
  class: "no-results"
};
var _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    Chart$1.register(plugin_title, plugin_tooltip, plugin_legend, ArcElement, RadialLinearScale);
    const props = __props;
    const statusConfig = {
    ...
    const chartData = computed(() => {
      ...
      const backgroundColor = Object.values(statusConfig).map((c) => `${c.color}CC`);
      const data = Object.keys(statusConfig).map((status) => counts[status] ?? 0);
      return {
        labels,
        datasets: [
          {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$5, [
        _cache[0] || (_cache[0] = createElementVNode(
          ...
          [
            createElementVNode("h2", null, "Order Status Distribution")
          ],
          -1
          /* CACHED */
        )),
        createElementVNode("div", _hoisted_2$3, [
          chartData.value.datasets?.[0]?.data?.length ? (openBlock(), createBlock(unref(PolarArea), {
            key: 0,
            data: chartData.value,
            options: chartOptions
          }, null, 8, ["data"])) : (openBlock(), createElementBlock("div", _hoisted_3$2, "No data available for the chart"))
        ])
      ]);
    };
  }
...
var css$4 = "\n.chart-section[data-v-229f0785] {\n  margin-bottom: 32px;\n}\n.chart-container[data-v-229f0785] {\n  height: 250px;\n  position: relative;\n  padding: 10px;\n}\n.no-results[data-v-229f0785] {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  height: 100%;\n}\n";
n(css$4,{});
...
var OrderChart = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-229f0785"]]);
...
const _hoisted_5$1 = { class: "virtual-table" };
const _hoisted_6$1 = { class: "table-row" };
const _hoisted_7 = { class: "col-id" };
const _hoisted_8 = { class: "col-name" };
const _hoisted_9 = { class: "col-customer" };
const _hoisted_10 = { class: "customer-info" };
const _hoisted_11 = { class: "customer-name" };
const _hoisted_12 = { class: "customer-email" };
const _hoisted_13 = { class: "col-status" };
const _hoisted_14 = { class: "col-date" };
const _hoisted_15 = { class: "col-actions" };
const _hoisted_16 = {
  key: 1,
  class: "no-results"
};
...
var _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  emits: ["add", "edit", "delete", "update:search", "update:status", "load-more"],
  setup(__props) {
    const statusOptions = [
      { text: "All", value: "all" },
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
          ...
          createElementVNode("div", _hoisted_3$1, [
            ...
            createElementVNode("div", _hoisted_4$1, [
              createVNode(_component_v_input, {
                ...
                small: "",
                class: "search-input",
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => _ctx.$emit("update:search", $event))
              }, {
                prepend: withCtx(() => [
              ...
              createVNode(_component_v_select, {
                ...
                clearable: "",
                class: "status-filter",
                "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => _ctx.$emit("update:status", $event))
              }, null, 8, ["model-value"])
            ])
          ]),
        ...
        createElementVNode("div", _hoisted_5$1, [
          _cache[7] || (_cache[7] = createStaticVNode('<div class="table-header" data-v-6572560e><div class="col-id" data-v-6572560e>ID</div><div class="col-name" data-v-6572560e>Order Name</div><div class="col-customer" data-v-6572560e>Customer</div><div class="col-status" data-v-6572560e>Status</div><div class="col-date" data-v-6572560e>Date</div><div class="col-actions" data-v-6572560e>Actions</div></div>', 1)),
          __props.orders.length > 0 ? (openBlock(), createBlock(unref(script$2), {
            key: 0,
            class: "scroller",
            items: __props.orders,
            "item-size": 64,
            "key-field": "id",
            onScrollEnd: _cache[3] || (_cache[3] = ($event) => _ctx.$emit("load-more"))
          }, {
              ...
              createElementVNode("div", _hoisted_6$1, [
                ...
                createElementVNode("div", _hoisted_9, [
                  createElementVNode("div", _hoisted_10, [
                    createElementVNode(
                      "div",
                      _hoisted_11,
                      toDisplayString(item.customer_name),
                      1
                      /* TEXT */
                    ),
                    createElementVNode(
                      "div",
                      _hoisted_12,
                      toDisplayString(item.customer_email),
                      1
                      /* TEXT */
                    )
                  ])
                ...
                createElementVNode("div", _hoisted_13, [
                  createElementVNode(
                    "span",
                    {
                      class: normalizeClass(["status-badge", item.status])
                    },
                ...
                createElementVNode(
                  "div",
                  _hoisted_14,
                  toDisplayString(item.order_date),
                  1
                  /* TEXT */
                ),
                createElementVNode("div", _hoisted_15, [
                  createVNode(_component_v_button, {
                    "x-small": "",
                    icon: "",
                    onClick: ($event) => _ctx.$emit("edit", item.id)
                  }, {
                    default: withCtx(() => [
                      createVNode(_component_v_icon, {
                        name: "edit",
            ...
            _: 1
            /* STABLE */
          }, 8, ["items"])) : createCommentVNode("v-if", true),
          __props.orders.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_16, " No orders found matching your criteria. ")) : createCommentVNode("v-if", true),
          __props.loading ? (openBlock(), createElementBlock("div", _hoisted_17, [
          ...
          !__props.hasMore && __props.orders.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_18, " You've reached the end of the list. ")) : createCommentVNode("v-if", true)
        ])
      ]);
    };
  }
...
var css$2 = "\n.virtual-table[data-v-6572560e] {\n  border: 1px solid var(--theme--border-color-subdued);\n  border-radius: 8px;\n  overflow: hidden;\n  display: flex;\n  flex-direction: column;\n  height: 600px;\n}\n.table-header[data-v-6572560e] {\n  display: grid;\n  grid-template-columns: 80px 150px 1fr 120px 120px 100px;\n  background: var(--theme--background-normal);\n  padding: 12px 16px;\n  font-weight: 600;\n  color: var(--theme--foreground-subdued);\n  border-bottom: 2px solid var(--theme--border-color);\n  font-size: 14px;\n}\n.scroller[data-v-6572560e] {\n  flex: 1;\n}\n.table-row[data-v-6572560e] {\n  display: grid;\n  grid-template-columns: 80px 150px 1fr 120px 120px 100px;\n  padding: 12px 16px;\n  border-bottom: 1px solid var(--theme--border-color-subdued);\n  align-items: center;\n  height: 64px;\n  box-sizing: border-box;\n}\n.table-row[data-v-6572560e]:hover {\n  background: var(--theme--background-normal);\n}\n.col-actions[data-v-6572560e] {\n  display: flex;\n  gap: 8px;\n}\n.loading-more[data-v-6572560e], .end-message[data-v-6572560e] {\n  padding: 16px;\n  text-align: center;\n  font-size: 14px;\n  color: var(--theme--foreground-subdued);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  gap: 8px;\n  background: var(--theme--background-normal);\n  border-top: 1px solid var(--theme--border-color-subdued);\n}\n.no-results[data-v-6572560e] {\n  padding: 40px;\n  text-align: center;\n  font-style: italic;\n  color: var(--theme--foreground-subdued);\n}\n";
n(css$2,{});

var RecentOrders = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-6572560e"]]);
      ...
      return openBlock(), createBlock(_component_private_view, { title: "Orders" }, {
        ...
        default: withCtx(() => [
          createElementVNode("div", _hoisted_1, [
            createVNode(_sfc_main$4, { orders: unref(orders) }, null, 8, ["orders"]),
            createVNode(OrderChart, { orders: unref(orders) }, null, 8, ["orders"]),
            createVNode(RecentOrders, {
              orders: unref(pagedOrders),
              ...
              "onUpdate:status": _cache[1] || (_cache[1] = ($event) => isRef(statusFilter) ? statusFilter.value = $event : null),
              onAdd: openAddModal,
              onEdit: openEditModal,
              onDelete: deleteOrder,
              onLoadMore: unref(orderStore).loadMore
            }, null, 8, ["orders", "loading", "has-more", "search", "status", "onLoadMore"]),
            createVNode(OrderModal, {
              active: isModalActive.value,
              order: editingOrder.value,
              onClose: _cache[2] || (_cache[2] = ($event) => isModalActive.value = false),
              onSave: handleSave
            }, null, 8, ["active", "order"])
          ])
        ]),
